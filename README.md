...
- The application is multicoloured, as a colourful interface is shown to symbolise fun and playfulness, and informality.
  ...
  3. Markers
     ...
     - Musuems: Beige as it symbolises quiet and elegance
...
- Mapbox.js
  ...
  - URL: https://docs.mapbox.com/mapbox.js/api/v3.3.1/
    ...
    - Mapbox Tiles
      ...
      - Used to implement base layers for the map (view.js line 355)

    - Mapbox-directions.js

      - URL: https://docs.mapbox.com/mapbox.js/example/v1.0.0/mapbox-directions/
      - Used to implement directions control box (view.js line 330)

    - Mapbox Geocoder

      - URL: https://docs.mapbox.com/mapbox.js/api/v3.3.1/l-mapbox-geocoder/
      - Used for reverse geocoding to get current user address and taxis’ addresses(script.js line 110 & 193)

    - Mapbox Omnivore

      - URL: https://docs.mapbox.com/mapbox.js/example/v1.0.0/markers-from-csv/
      - Used to convert tourist attraction kml file to geojson (view.js line 182)
...
- jQuery usage to click inside popup and do javascript
  ...
  - Idea for how to implement functionality of buttons inside popups (helpers.js line 468)
- To register input content programmatically
  ...
  - Used because directions control did not register the lat lng programmatically inputted into input box with Javascript (script.js line 118 & 172, helpers.js line 214)
