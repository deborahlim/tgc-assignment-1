...
| ----------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Using the Get User Location & Taxi Availability Button                  | See current location on map Get address of current location Find a taxi near my location                                                                                                  | 1. Click on User Location Button. A marker will appear. 2. Hover over the marker to see current location. 3. Directions panel will appear and current latitude and longitude will be inside the directions origin input 4. Click on the Taxi Availability Button to see the available nearby taxis. 5. Click on a taxi maker to reveal the taxi’s location. 6. Zooming out the map will reveal the different group clusters. Red groups indicate a high number of taxis in that area, yellow groups indicate lesser taxis and green groups indicate very few taxis.                                                                                                                                        |
| Toggling Map Layers (Base and Overlay) using the layer control box      | View the the map of Singapore from a different perspective Explore the many heritage sites, heritage trees and tourist attractions, museums in Singapore                                  | 1. Layer Control Box is on the top right corner of the map 2. Hover over box to open. 3. For base layer, choose between street view, outdoor view and satellite view by clicking on each corresponding radio button 4. For Overlay Layer, tick the corresponding checkbox to show the corresponding markers on the map. Multiple layers can be chosen.                                                                                                                                                                                                                                                                                                                                                     |
| Exploring Map Markers                                                   | Get information about heritage sites, tourist attractions, museums                                                                                                                        | 1. Click on map marker to open the pop up and view information about the place of interest 2. Click on the directions button in the pop up of each marker. The location will be put into the destination of the directions panel. 4. Click on the nearby food places button in the pop up to trigger food recommendations. These will appear as markers as well as in a list format in the side panel. For tourist attraction markers only: 5. More information about the attraction will appear in side panel when the marker is clicked. 6. Click on the link to go to the attraction’s website 7. The directions button and nearby food button for that attraction can also be found in the side panel. |
| Using the Directions / Routing Panel                                    | Get to desired location                                                                                                                                                                   | 1. Click Get directions button in the pop ups (Or side panel for tourist attraction markers) 2. The marker’s location will be appear in the destination input of direction panel. 3. Both origin and destination inputs must be filled up before pressing enter. 4. Click on driving / cycling / walking button to show the routes for each mode of transport 5. Click on reverse icon in between the input boxes to reverse the origin and destination input.                                                                                                                                                                                                                                             |
| Using the Nearby Food Button & getting nearby food recommendations      | Get food recommendations nearby current location Get food recommendations nearby markers Get food recommendations in a specific area                                                      | 1. Click the Explore nearby food button in the side panel 2. The recommendations will be limited to those with locations within the map view 3. Input a type of food or cuisine in the nearby food input box to specify the food type that you are interested in. 4. Click the nearby food button in each marker pop up to get recommendations near that marker.                                                                                                                                                                                                                                                                                                                                           |
| Exploring Food Recommendations & Get Directions to food Recommendations | Get the details of Food Recommendations Sort Food Recommendations (For food Recommendations triggered by clicking the nearby food button in a marker pop up / attraction side panel only) | 1. Hover over the food marker to see the name of the food recommendation 2. Click on the marker to get its location. The location will in input into the destination input of the directions panel. 3. More details of the food recommendation is shown in the side panel 4. Hover over each food result in the side panel to see the corresponding marker’s pop up 5. Click on the food result in the side panel to zoom into that marker on the map 6. Click the dropdown to sort the food results according to distance from the marker in question. The default will be sorted by relevance.                                                                                                           |
| Searching for Specific Markers                                          | Find a specific place of interest                                                                                                                                                         | 1. Type in a key word. 2. Press enter or click the search button. Only map markers which contain the keyword will appear.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| Searching for specific Foods                                            | Find a specific type of food                                                                                                                                                              | 1. Type in a keyword relating to food 2. Press enter or click the search button. 3. Option to sort results by distance or popularity                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| Using the clear button in the search input boxes                        | Clear the markers in the map and information in the side panel                                                                                                                            | 1. Click the cross button in the marker search input box to clear the side panel and map markers 2. Click the cross button in the marker search input box to clear the food markers and side panel.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
